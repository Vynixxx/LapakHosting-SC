...
<head>
    ...
    <title>Security Guaranteed</title>
...
<body>
  ...
  <div class="card text-bg-primary mb-auto" style="max-width: 100%;">
    <div class="container"><br><br>
      <div class="card-header display-6">Security Guaranteed</div>
      <br><br>
    </div>
  </div>
  <br><br><br>
  <div class="container">
    <p class="text-center h5">Our Safety</p>
    <div class="h2 text-center text-uppercase">Security <span class="text-primary"><strong> Guarantee</strong></span></div><br></div>
  <br><br>
  <div class="container">
    <div class="mx-3">
      <div class="card-body">
        <h5 class="card-text">Security Control</h5>
      ...
      <div class="card-body">
        <h5 class="card-text">Your Privacy</h5>
        <p class="my-4">
