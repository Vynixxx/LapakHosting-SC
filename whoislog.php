...
<body>
    ...
    <div class="container">
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
        ...
        <div class="offcanvas-body">
          ...
          <div>
            <a class="btn btn-white" href="hostinglog.php">
  ...
  <div class="card text-bg-primary mb-auto" style="max-width: 100%;">
    <div class="container"><br><br>
      <div class="card-header display-6">WHOIS Lookup</div>
      <br><br>
    </div>
  </div>
  <br><br><br>
  <div class="container">
    <p class="text-center h5">Search for Domains</p>
    <div class="h2 text-center text-uppercase">Whois <span class="text-primary"><strong>Lookup</strong></span></div><br></div>
  <div class="container">
  ...
  <p class="text-center h5">Any Questions?</p>
    <div class="h2 text-center text-uppercase">Ask a <span class="text-primary"><strong>Question</strong></span></div><br></div>
    <div class="container">
    <!-- Default box -->
